...
export default function Profile() {
  ...
  const options = [
    ...
    {
      icon: <FaSync className="text-blue-700" />,
      label: "Sincronizar dados bancários",
    },
    {
      icon: <FaQuestionCircle className="text-blue-700" />,
  ...
  return (
    <div className="flex flex-col items-center justify-start p-6 bg-white rounded-2xl shadow-sm mx-auto mt-6">
      ...
      <div className="relative mb-4">
        ...
        <button className="absolute bottom-1 right-1 bg-blue-900 text-white p-2 rounded-full text-xs shadow-md hover:bg-blue-950 transition">
          <FaPen size={10} />
        </button>
      </div>
